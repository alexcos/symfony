...
/**
 * Exception for resweb json_decode
 */
class ReswebJsonDecodeException extends G4Exception
{
    private $reqUrl;
    private $reqBody;
     ...
     *
     * @access public
     * @return \G4\UtilBundle\Exception\ReswebJsonDecodeException
     */
    ...
    {
        return sprintf(
            'Bad Resweb Json received for url %s, sent `%s`',
            $this->reqUrl,
            $this->reqBody
        );
    }
